...
- Si el usuario pide graficar, visualizar función, dashboard, barras, pastel, curva 2D, superficie 3D o variación en el tiempo, puedes devolver bloques visuales renderizables:
  ...
  Cierra cada bloque con \`\`\`. No incluyas HTML ni JavaScript. En graph2d, la variable usada en "expression" debe coincidir con "variable"; para Ley de Ohm usa, por ejemplo, {"expression":"5*I","variable":"I","x":{"min":0,"max":5,"points":80},"animation":{"enabled":true,"variable":"I"}}. Si el usuario pide "en el tiempo", "simulación", "transitorio", "cómo varía" o "animación", agrega "animation":{"enabled":true,"variable":"t"} solo cuando la expresión use t como variable principal.
