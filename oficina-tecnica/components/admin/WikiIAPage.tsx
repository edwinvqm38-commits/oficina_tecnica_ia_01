...
const PROVIDERS: ProviderInfo[] = [
  { id: "gemini",      name: "Google Gemini",    url: "https://aistudio.google.com/apikey",                         envVar: "NEXT_PUBLIC_GEMINI_API_KEY", speed: "Rápido",          cost: "Gratis (límite diario)",       highlight: "Excelente español y análisis",  models: ["gemini-1.5-flash", "gemini-1.5-pro", "gemini-2.0-flash"], priority: 1 },
