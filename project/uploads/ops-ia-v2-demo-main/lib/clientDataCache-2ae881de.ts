import { listCotizaciones, type QuotationsListResult } from "@/lib/quotationsRepository";
import {
  listRequirementItems,
  listRequirementItemsByRequirementId,
  type RequirementItemsListResult,
} from "@/lib/requirementItemsRepository";
import { listRequerimientos, type RequirementsListResult } from "@/lib/requirementsRepository";
import type { AppDataSource } from "@/lib/dataSourceDiagnostics";
