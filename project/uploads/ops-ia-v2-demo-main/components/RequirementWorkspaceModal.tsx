...
import type { EstadoRequerimiento, Recurso, Requerimiento } from "@/lib/demoData";
import { formatCurrencyNumber, formatDate } from "@/lib/utils";
              ...
              <div className="flex h-full flex-col">
                <div className="mb-1 flex min-h-6 items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button onClick={onSave} className={workspaceActionButtonClassName()}>
