...
import { demoData, type Recurso } from "@/lib/demoData";
import { getModulePermissions, type ModulePermissions } from "@/lib/modulePermissionsRepository";
import { createProposalLogoDraft, readProposalLogos, writeProposalLogos, type ProposalLogo, type ProposalLogoEntityType } from "@/lib/proposalLogos";
import {
  createRecurso,
  listAllRecursos,
  ...
  return (
    <section className="app-table-section flex min-h-[calc(100vh-64px)] min-w-0 flex-col">
      ...
      <ResourceFormModal
        ...
        allowFilePicker={dataSource !== "supabase"}
